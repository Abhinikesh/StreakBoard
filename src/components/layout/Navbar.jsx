...
export default function Navbar() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-700 shadow-sm">
      <div className="max-w-5xl mx-auto px-4 sm:px-6">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center">
            ...
            >
              <span className="text-xl sm:text-2xl font-extrabold text-indigo-600 dark:text-indigo-400 tracking-tight">StreakBoard</span>
            </button>
          ...
          <div className="flex items-center md:hidden">
            <button
              ...
              className="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-300 hover:text-gray-500 hover:bg-gray-100 dark:hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500"
            >
      ...
      {/* Mobile Menu Panel */}
      {isMobileMenuOpen && (
        <div className="md:hidden absolute w-full bg-white dark:bg-gray-900 shadow-xl border-b border-gray-100 dark:border-gray-700">
          ...
          <div className="pt-4 pb-4 border-t border-gray-100 dark:border-gray-700 px-4">
            ...
            <button
              ...
              className="mt-2 block w-full text-center px-4 py-3 text-base font-bold text-red-600 dark:text-red-400 hover:bg-red-50 dark:hover:bg-red-900/20 rounded-xl transition-colors"
            >
